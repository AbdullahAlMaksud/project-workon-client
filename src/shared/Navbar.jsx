...
import { BiCross, BiLock, BiMenu, BiUser } from 'react-icons/bi';
                ...
                <section className='w-11/12 container mx-auto'>
                    ...
                    <div className='w-full flex justify-between md:grid md:grid-cols-3'>
                        ...
                        <div className='hidden col-span-2 md:flex justify-end items-center gap-7'>
                            ...
                            <div>
                                <Link to={'/signin'}><button className='bg-red-700 text-white font-poppins px-8 py-2 rounded-md text-sm hover:bg-red-800 active:scale-95'>Login</button></Link>
                            </div>
                        </div>
