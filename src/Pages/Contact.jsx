        ...
        <div className='container w-11/12 mx-auto my-10 '>
            <section className="bg-[url('https://images.unsplash.com/photo-1521747116042-5a810fda9664')] bg-cover dark:bg-[url('https://images.unsplash.com/photo-1521747116042-5a810fda9664')] rounded-2xl">
                <div className='bg-black/70 rounded-2xl p-5 md:p-10 '>
                    <div className="flex justify-center flex-col min-h-screen bg-gray-100/95 rounded-2xl px-5 md:px-20 py-20">
                        <div>
                            <div className="flex flex-col justify-center items-center mb-6">
                                <h2 className="text-white bg-red-700 px-5 py-1 -rotate-2 font-bold text-3xl text-center">Contact Info</h2>
                                <p className="md:w-2/3 text-center text-sm pt-3">Feel free get in touch with us!</p>
                            </div>

                            <div className='grid grid-cols-1 lg:grid-cols-3 gap-3'>
                                <a href="https://maps.app.goo.gl/9UYdnVfmf2so5brQ8">
                                    <div className='rounded-xl bg-gray-50/50 flex flex-col items-center gap-2 justify-center py-10 px-10 lg:min-h-40'>
                                        <div>
                                            <HiLocationMarker className='text-3xl' />
                                        </div>
                                        <div>
                                            <h4 className='text-center'>51, West Tejturi Bazar, Dhaka-1216</h4>
                                        </div>
                                    </div>
                                </a>
                                <a href="tel:+8801767211795">
                                    <div className='rounded-xl bg-gray-50/50 flex flex-col items-center gap-2 justify-center py-10 px-10 lg:min-h-40'>
                                        ...
                                        <div>
                                            <h4 className='text-center'>+880 (1767) 211795</h4>
                                        </div>
                                    </div>
                                </a>
                                <a href="mailto:maksud.workspace@gmail.com">
                                    <div className='rounded-xl bg-gray-50/50 flex flex-col items-center gap-2 justify-center py-10 px-10 lg:min-h-40'>
                                        ...
                                        <div>
                                            <h4 className='text-center overflow-auto'>maksud.workspace@gmail.com</h4>
                                        </div>
                                    </div>
                                </a>
                                <div>
                        ...
                        <div>
                            <div className="flex flex-col justify-center items-center mb-6 mt-10">
                                <h2 className="text-white bg-red-700 px-5 py-1 -rotate-2 font-bold text-2xl md:text-3xl text-center">Where we are?</h2>
                        ...
                        <div className="flex flex-col justify-center items-center mb-6 mt-10">
                            <h2 className="text-white bg-red-700 px-5 py-1 -rotate-2 font-bold text-2xl md:text-3xl text-center">Anything to say?</h2>
                            <p className="md:w-2/3 text-center text-sm pt-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea itaque vitae quasi, possimus veniam aut.</p>
                        </div>
