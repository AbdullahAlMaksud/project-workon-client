...
const Sidebar = ({ mainMenu }) => {
    ...
    return (
        <div className=' bg-red-700 rounded-b-xl shadow-black/50 shadow-xl '>
            ...
            <div className="py-4 flex flex-col justify-between min-h-[calc(100vh-324px)] ">
                <div className="">
                    <ul>
                        {
                            mainMenu
                ...
                <div className="flex flex-col items-start text-black">
                    <Link to={'/'} className="flex items-center gap-3 py-1 px-12 hover:bg-gray-800/10 w-full">
                        <TbSmartHome />
                        Home
                    </Link>
                    <button className="flex items-center gap-3 py-1 px-12 hover:bg-gray-800/10 w-full">
                        <VscSignOut />
                        Sign Out
                    </button>
                </div>
