import { FcConferenceCall, FcPositiveDynamic } from "react-icons/fc";
    ...
    return (
        <div className="dark:text-white container mx-auto w-11/12 my-12 lg:my-5 h-full">
            <div>
                ...
                <p className="bg-red-400 w-fit px-5 rounded-full mt-2 font-poppins text-sm py-0.5 text-red-800 capitalize">{
                    `${role}`
                }</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-12 gap-3 mt-5">
                <Link to={'all-employee-list'} className="md:col-span-6 bg-gray-200 dark:bg-gray-900 hover:dark:bg-gray-800 rounded-lg shadow-lg p-5 flex justify-center items-center flex-col hover:bg-gray-100">
